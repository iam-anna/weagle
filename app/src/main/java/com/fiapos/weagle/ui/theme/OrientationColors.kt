...
fun StrategicOrientationCategory.toColor(): OrientationColors {
    return when(this) {

        StrategicOrientationCategory.INNOVATION -> {
            OrientationColors(
        ...
        StrategicOrientationCategory.COST_REDUCTION -> {
            OrientationColors(
        ...
        StrategicOrientationCategory.PRODUCTIVITY -> {
            OrientationColors(
        ...
        StrategicOrientationCategory.SUSTAINABILITY -> {
            OrientationColors(
        ...
        StrategicOrientationCategory.TECHNOLOGY -> {
            OrientationColors(
